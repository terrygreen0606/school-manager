...
class Mission extends Component {
    ...
    componentDidMount()
    {
        let login_token = sessionStorage.getItem('login_token');
            axios.post(globalVariables.admin_api_path+'/setup/search-cms-page', {search_f: 'page_key', model_call: 'Setup_cms', search_text: 'mission'}, {
    ...
    handleSubmit = event => {
        ...
        TempPageData.fillable_value = 'mission';
      ...
      formData.append('avatar_prefix','mission_');
      let login_token = sessionStorage.getItem('login_token');
              ...
              <Card
                ...
                content={
                  <form  onSubmit={this.handleSubmit}>
                    ...
                    <img alt="Our Mission" height="150px" src = {this.state.FImage ? this.state.FImage : avatar}/>
