...
class Contact extends Component {
    ...
    componentDidMount()
    {
        let login_token = sessionStorage.getItem('login_token');
            axios.post(globalVariables.admin_api_path+'/setup/search-cms-page', {search_f: 'page_key', model_call: 'Setup_cms', search_text: 'contact_us'}, {
    ...
    handleSubmit = event => {
        ...
        TempPageData.fillable_value = 'contact_us';
      ...
      formData.append('avatar_prefix','contact_');
      let login_token = sessionStorage.getItem('login_token');
