...
class RepurchaseCommissionSetup extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showModal: false,
            ...
            return (
              <Row>
                <Col md={12}>
                    ...
                    <FormGroup>
                      <ControlLabel>Repurchase Commission</ControlLabel>
                      <FormControl name="repurchase_commission" type="number" defaultValue={SetupItem.repurchase_commission} onChange={this.handleChange}/>
                    </FormGroup>
            </Col>
              </Row>
            );
      ...
      handleSubmit = event => {
        ...
        axios.post(globalVariables.admin_api_path+'/setup/update-level-commission', {id: this.state.setup_key, level: this.state.level, repurchase_commission: this.state.repurchase_commission, description: this.state.description},{
          headers: { Authorization: "Bearer " + login_token }
        })
          .then(res => {
    ...
    onOpenModal = (i, key) => {
      ...
      this.setState({
        ...
        repurchase_commission: SetupItem.repurchase_commission
      })
    };
                ...
                content={
                  <Table responsive>
                    ...
                    <td>{SetupItem.description}</td>
                        <td>{SetupItem.repurchase_commission}</td>
            ...
            <Modal
                    ...
                    >
                      ...
                      <Modal.Header closeButton>
                        <Modal.Title>Update Repurchase Commission</Modal.Title>
                      </Modal.Header>
                      <Modal.Body>
                      {this.renderModal()}
                      </Modal.Body>
...
export default RepurchaseCommissionSetup;
