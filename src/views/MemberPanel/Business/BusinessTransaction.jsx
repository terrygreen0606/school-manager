...
class BusinessTransactions extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showModal: false,
        ...
        componentDidMount() {
          ...
          axios.post(globalVariables.user_api_path+'/ewallet/transaction', {model_call: 'Transaction', search_f:'transaction_id', user_id: user_id}, {
